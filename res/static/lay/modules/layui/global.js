...
layui.define(['code', 'element', 'table', 'util', 'carousel', 'laytpl'], function(exports){
  ...
  ;!function(){
    ...
    form.on('select(component)', function(data){
      ...
      location.href = /^\//.test(value) ? value : (layui.cache.dir + '../../../layui/doc/'+ value);
    });
  }();
  ...
  ;!function(){
    ...
    (function(data){
      ...
      element.render('nav');
    })([{"classname":"toptg","key":"toptg-notice","title":"layui 官网下线公告","url":layui.cache.dir + "../../../layui/about/notice.html","CONFIG_TIME":"9/26/2021, 6:25:48 PM","tips":"","tipsCss":"background-image: linear-gradient(to right,#359FD4,#36B5C8,#25D8AB","hot":"1"}]);
  }();
